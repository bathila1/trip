...
//     //importing the function to filter destinations by category and sending the selected category name

//     const {destinationByCategory} = useDestinationContext();

//     return (
//       <TouchableOpacity onPress={() => destinationByCategory(name)}>
//         <View style={[styles.tagContainer, selected && { backgroundColor: '#45802e', color:'#fff' }]}>
