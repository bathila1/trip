...
// const Destinations = () => {
//   //getting all destinations from context
//   const {destinations,favorites, categories, filteredDestinations, selectCategory} = useDestinationContext()
...
//             horizontal
//             renderItem={({item}) => {
//               return(<HorizontalTag list={item} selected={selectCategory === item.name} />)
//             }} />
//         </View>
